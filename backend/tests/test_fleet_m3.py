...
class TestClassifyUplinkSeq:
    ...
    def test_first_frame_advances(self):
    ...
    def test_restart_when_far_below(self):
        # Agent restarted: per-process counter reset to 1 after 5000 frames.
        assert classify_uplink_seq(5000, 1) == UPLINK_SEQ_RESTART
